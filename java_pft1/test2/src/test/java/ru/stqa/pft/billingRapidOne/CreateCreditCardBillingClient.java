package ru.stqa.pft.billingRapidOne;
...
public class CreateCreditCardBillingClient {
    ...
    public void testCreditCardBillingClient() throws Exception {
        ...
        driver.findElement(By.id("LoginID")).sendKeys("10901");
      ...
      //  driver.findElement(By.id("EditedCustomer_Phone")).click();
        ...
        driver.findElement(By.id("EditedCustomer_Totalsum")).sendKeys("47");
