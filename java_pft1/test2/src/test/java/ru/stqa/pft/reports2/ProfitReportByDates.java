...
public class ProfitReportByDates {
    ...
    @Test
    public void testProfitReportByDates() throws Exception {
        ...
        driver.findElement(By.id("ReceiptsRep")).click();
