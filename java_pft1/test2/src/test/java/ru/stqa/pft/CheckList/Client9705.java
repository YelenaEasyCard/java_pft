...
public class Client9705 {
    ...
    public void testCheckList() throws Exception {
        ...
        driver.findElement(By.id("CardNumber")).click();
        driver.findElement(By.id("CardNumber")).clear();
        driver.findElement(By.id("CardNumber")).sendKeys("37510190000062");
       ...
       // DEAL WITH INVOICE
        ...
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        try {
            assertTrue(isElementPresent(By.id("MenuActivties")));
        } catch (Error e) {
        ...
        driver.findElement(By.id("FromDate")).sendKeys("07/10/2019");
        ...
        driver.findElement(By.id("toDate")).sendKeys("07/10/2019");
        driver.findElement(By.cssSelector("div.row.container")).click();
        Thread.sleep(4000);
