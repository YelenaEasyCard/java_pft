package ru.stqa.pft.billingInitiations;
...
public class CreateCreditCardBillingClientTrue {
    ...
    public void testCreditCardBillingClient() throws Exception {
        ...
        driver.findElement(By.id("LoginID")).sendKeys("10816");
      ...
      //  driver.findElement(By.id("EditedCustomer_Phone")).click();
        ...
        new Select(driver.findElement(By.id("EditedCustomer_ValYear"))).selectByVisibleText("2020");
        driver.findElement(By.id("EditedCustomer_ValYear")).click();
        ...
        driver.findElement(By.id("EditedCustomer_Totalsum")).sendKeys("41");
