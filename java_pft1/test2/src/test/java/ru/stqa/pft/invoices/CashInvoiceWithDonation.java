...
public class CashInvoiceWithDonation {
    ...
    @Test
    public void testCashInvoiceWithDonation() throws Exception {
        ...
        new Select(driver.findElement(By.id("PaymentModel_paymentMethod"))).selectByValue("CASH");
        ...
        driver.findElement(By.id("MarkAsDonation")).click();
