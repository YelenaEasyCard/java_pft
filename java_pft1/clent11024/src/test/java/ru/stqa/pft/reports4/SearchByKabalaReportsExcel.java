...
public class SearchByKabalaReportsExcel {
    ...
    @Test
    public void testInvoicesReportsPDF() throws Exception {
        ...
        new Select(driver.findElement(By.id("ddlDocType"))).selectByValue("xlsx");
