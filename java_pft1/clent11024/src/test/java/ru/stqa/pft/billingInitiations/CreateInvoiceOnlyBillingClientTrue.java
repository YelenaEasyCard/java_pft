...
public class CreateInvoiceOnlyBillingClientTrue {
    ...
    @Test
    public void testCreateInvoiceOnlyBillingClient() throws Exception {
        ...
        driver.findElement(By.id("EditedCustomer_Totalsum")).sendKeys("43");
