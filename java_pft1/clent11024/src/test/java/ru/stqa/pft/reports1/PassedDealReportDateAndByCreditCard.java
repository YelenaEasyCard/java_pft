...
public class PassedDealReportDateAndByCreditCard {
    ...
    @Test
    public void testPassedDealReportDateAndByCreditCard() throws Exception {
        ...
        driver.findElement(By.id("CardNumber")).sendKeys("2546");
