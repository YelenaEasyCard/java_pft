...
public class CreditCardIInstallmentInvoice {
    ...
    @Test
    public void testCreditCardInstantBillingInvoice() throws Exception {
        ...
        new Select(driver.findElement(By.id("PaymentModel_paymentMethod"))).selectByValue("CREDIT_CARD_INSTALLMENT_CLUB_DEAL");
        new Select(driver.findElement(By.id("PaymentModel_creditCardType"))).selectByValue("VISA");
        driver.findElement(By.id("PaymentModel_creditCard4LastDigits")).click();
        driver.findElement(By.id("PaymentModel_creditCard4LastDigits")).clear();
        driver.findElement(By.id("PaymentModel_creditCard4LastDigits")).sendKeys("4586");
        new Select(driver.findElement(By.id("PaymentModel_numberOfPayments"))).selectByVisibleText("7");
        driver.findElement(By.id("tr_payments_payments_first")).click();
        driver.findElement(By.id("PaymentModel_amountOfFirstPayment")).clear();
        driver.findElement(By.id("PaymentModel_amountOfFirstPayment")).sendKeys("10");
