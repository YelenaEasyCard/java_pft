...
public class Client7899 {
    ...
    public void testCheckList() throws Exception {
     ...
     driver.findElement(By.id("create-user")).click();
        ...
        driver.findElement(By.id("EditedCustomer_FirstPayDate")).sendKeys("11/11/2019");
       ...
       Thread.sleep(6000);
        ...
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        WebElement  elemXt = driver.findElement(By.id("accordionClientDetails1"));
        Thread.sleep(4000);
        driver.findElement(By.xpath("//div[@id='divCreateEditCustomer']/div/form/div[2]/button")).click();
        driver.manage().timeouts().implicitlyWait(3000, TimeUnit.SECONDS);
        driver.findElement(By.id("EditedCustomer_LastName")).click();
       ...
       for (int second = 0;; second++) {
          if (second >= 60) fail("timeout");
          try { if (driver.findElement(By.id("BillingSystem")).isDisplayed()) break; } catch (Exception e) {
          }
       }
          Thread.sleep(6000);
        //Make ORAT KEVA BILLING
