...
public class Client11501 {
    ...
    public void testCheckList() throws Exception {
        ...
        driver.findElement(By.id("LoginID")).sendKeys("11501");
        ...
        */
        ...
        driver.findElement(By.id("CardNumber")).sendKeys("375510390000037=220320119032597012200");
        ...
        driver.findElement(By.id("CVV2")).sendKeys("246");
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        ...
        driver.findElement(By.id("CVV")).sendKeys("246");
        driver.findElement(By.id("TZ")).click();
        driver.findElement(By.id("TZ")).clear();
        driver.findElement(By.id("TZ")).sendKeys("348658899");
