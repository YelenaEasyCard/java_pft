...
public class CreateOratKevaBillingClientTrue {
    ...
    @Test
    public void testOratKevaBillingClient() throws Exception {
       ...
       // driver.findElement(By.cssSelector("#divCreateEditCustomer > div > form > div.DialogHeaderShape")).click();
        ...
        driver.findElement(By.id("EditedCustomer_Totalsum")).sendKeys("45");
