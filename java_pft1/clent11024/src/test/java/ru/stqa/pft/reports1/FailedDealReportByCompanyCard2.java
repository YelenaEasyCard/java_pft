...
public class FailedDealReportByCompanyCard2 {
    ...
    @Test
    public void testFailedDealReportByCompanyCard2() throws Exception {
        ...
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("-1");
        ...
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("0");
        driver.findElement(By.cssSelector("[name=StatusType][value=\"Fail\"]")).click();
        driver.findElement(By.id("btnSubmit")).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.findElement(By.id("FirstPageBtn"));
        ...
        driver.findElement(By.id("FirstPageBtn"));
        driver.findElement(By.cssSelector("[name=printReport][onclick=\"JavaScript: window.location.href = '../Home/Report1';\"]")).click();
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("2");
        driver.findElement(By.cssSelector("[name=StatusType][value=\"Fail\"]")).click();
        driver.findElement(By.id("btnSubmit")).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.findElement(By.id("FirstPageBtn"));
        driver.findElement(By.cssSelector("[name=printReport][onclick=\"JavaScript: window.location.href = '../Home/Report1';\"]")).click();
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("3");
        driver.findElement(By.cssSelector("[name=StatusType][value=\"Fail\"]")).click();
        driver.findElement(By.id("btnSubmit")).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.findElement(By.id("FirstPageBtn"));
        driver.findElement(By.cssSelector("[name=printReport][onclick=\"JavaScript: window.location.href = '../Home/Report1';\"]")).click();
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("4");
        driver.findElement(By.cssSelector("[name=StatusType][value=\"Pass\"]")).click();
        driver.findElement(By.id("btnSubmit")).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.findElement(By.id("FirstPageBtn"));
        driver.findElement(By.cssSelector("[name=printReport][onclick=\"JavaScript: window.location.href = '../Home/Report1';\"]")).click();
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("5");
        driver.findElement(By.cssSelector("[name=StatusType][value=\"Fail\"]")).click();
        driver.findElement(By.id("btnSubmit")).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.findElement(By.id("FirstPageBtn"));
        driver.findElement(By.cssSelector("[name=printReport][onclick=\"JavaScript: window.location.href = '../Home/Report1';\"]")).click();
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("6");
        driver.findElement(By.cssSelector("[name=StatusType][value=\"Fail\"]")).click();
        driver.findElement(By.id("btnSubmit")).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.findElement(By.id("FirstPageBtn"));
        driver.findElement(By.cssSelector("[name=printReport][onclick=\"JavaScript: window.location.href = '../Home/Report1';\"]")).click();
        new Select(driver.findElement(By.id("Manpika"))).selectByValue("50");
        driver.findElement(By.cssSelector("[name=StatusType][value=\"Fail\"]")).click();
        driver.findElement(By.id("btnSubmit")).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.findElement(By.id("FirstPageBtn"));
