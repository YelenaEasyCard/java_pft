...
public class Client7899 {
    ...
    public void testCheckList() throws Exception {
        ...
        driver.findElement(By.id("Password")).click();
        driver.findElement(By.id("Password")).clear();
        driver.findElement(By.id("Password")).sendKeys("test123321");
        driver.findElement(By.id("btnEnter")).click();
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        Thread.sleep(4000);
        ...
        driver.findElement(By.id("FromDate")).sendKeys("02/02/2020");
        ...
        driver.findElement(By.id("toDate")).sendKeys("02/02/2020");
        driver.findElement(By.cssSelector("div.row.container")).click();
        Thread.sleep(4000);
