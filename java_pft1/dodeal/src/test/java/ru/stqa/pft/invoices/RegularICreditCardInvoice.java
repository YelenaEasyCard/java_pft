...
public class RegularICreditCardInvoice {
    ...
    @Test
    public void testRegularCreditCardInvoice() throws Exception {
        ...
        new Select(driver.findElement(By.id("PaymentModel_paymentMethod"))).selectByValue("CREDIT_CARD_REGULAR_CREDIT");
