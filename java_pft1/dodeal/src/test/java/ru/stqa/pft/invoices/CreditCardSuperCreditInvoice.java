...
public class CreditCardSuperCreditInvoice {
    ...
    @Test
    public void testCreditCardSuperCreditInvoice() throws Exception {
        ...
        new Select(driver.findElement(By.id("PaymentModel_paymentMethod"))).selectByValue("CREDIT_CARD_SUPER_CREDIT");
        ...
        new Select(driver.findElement(By.id("PaymentModel_numberOfPayments"))).selectByValue("7");
