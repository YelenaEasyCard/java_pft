...
public class CreditCardCreditInvoice {
    ...
    @Test
    public void testCreditCardCreditInvoice() throws Exception {
        ...
        new Select(driver.findElement(By.id("PaymentModel_paymentMethod"))).selectByValue("CREDIT_CARD_CREDITS");
