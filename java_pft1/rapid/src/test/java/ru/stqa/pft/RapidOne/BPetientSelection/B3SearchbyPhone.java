...
public class B3SearchbyPhone {
    ...
    @Test
    public void testSearhbyPhone() throws Exception {
        ...
        driver.findElement(By.id("phone")).sendKeys("0585456911");
        driver.findElement(By.xpath("//button[@type='submit']")).click();
        Thread.sleep(3000);
        try {
            assertEquals(driver.findElement(By.xpath("//table[@id='navigation_table_list']/tbody/tr/td[2]")).getText(), "Yelenak");
        } catch (Error e) {
