...
public class PreviousPatients {
    ...
    public void testLoginLogout() throws Exception {
        ...
        driver.findElement(By.linkText("Dan Dan")).click();
        Thread.sleep(4000);
        try {
            assertEquals(driver.findElement(By.cssSelector("div.patientName.flex-1-0-0.overflow-ellipsis-name > span.ng-binding.ng-scope")).getText(), "Dan Dan");
        } catch (Error e) {
