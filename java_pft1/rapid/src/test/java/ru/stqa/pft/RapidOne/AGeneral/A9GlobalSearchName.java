...
public class A9GlobalSearchName {
    ...
    @Test
    public void testGlobalSearchPhone() throws Exception {
        ...
        driver.findElement(By.id("global_search_input")).sendKeys("Yelenak Korsakov");
        Thread.sleep(3000);
        driver.findElement(By.id("global_search_input")).sendKeys(Keys.ENTER);
        Thread.sleep(3000);
        try {
            assertEquals(driver.findElement(By.cssSelector("div.patientName.flex-1-0-0.overflow-ellipsis-name > span.ng-binding.ng-scope")).getText(), "Yelenak Korsakov");
        } catch (Error e) {
