...
public class ShiftManagementBlockDeletion {
    ...
    public void testShiftManagementDel() throws Exception {
        ...
        Thread.sleep(6000);
        driver.findElement(By.xpath("//*/text()[normalize-space(.)='Blocks']/parent::*")).click();
        ...
        driver.findElement(By.xpath("//*/text()[normalize-space(.)='Load blocks']/parent::*")).click();
        Thread.sleep(4000);
        driver.findElement(By.xpath("//table[@id='navigation_table_list']/tbody/tr[2]/td[8]/i[2]")).click();
