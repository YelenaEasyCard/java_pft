...
public class ShiftManagementNew {
    ...
    public void testLoginLogout() throws Exception {
        ...
        driver.findElement(By.xpath("//*/text()[normalize-space(.)='New shift']/parent::*")).click();
       ...
       driver.findElement(By.id("doctor")).click();
        //new Select(driver.findElement(By.id("doctor"))).selectByVisibleText("חדר A");
