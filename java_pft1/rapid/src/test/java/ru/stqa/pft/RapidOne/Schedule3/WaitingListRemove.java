...
public class WaitingListRemove {
    ...
    @Test
    public void testWaitingListRemove() throws Exception {
        ...
        driver.findElement(By.xpath("//button[@id='waiting_list_btn']/img")).click();
           Thread.sleep(4000);
       // driver.findElement(By.cssSelector("td > div.custom-checkbox > label.masterCB.lblForCB.label-checkbox")).click();
        driver.findElement(By.cssSelector("i.glyphicon.glyphicon-trash")).click();
