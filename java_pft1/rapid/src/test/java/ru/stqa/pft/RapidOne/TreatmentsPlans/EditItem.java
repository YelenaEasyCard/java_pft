...
public class EditItem {
    ...
    public void testEditPlan() throws Exception {
        ...
        Thread.sleep(4000);
        driver.findElement(By.xpath("//*/text()[normalize-space(.)='Edit']/parent::*")).click();
        Thread.sleep(4000);
        driver.findElement(By.id("unit_price")).click();
        driver.findElement(By.id("unit_price")).clear();
        driver.findElement(By.id("unit_price")).sendKeys("20");
        driver.findElement(By.xpath("//*/text()[normalize-space(.)='Submit']/parent::*")).click();
        Thread.sleep(4000);
