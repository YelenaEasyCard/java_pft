...
public class DeleteItem {
    ...
    public void testEditPlan() throws Exception {
        ...
        WebElement elementk = driver.findElement(By.xpath("//div[@id='table_container']/treatment-table-detailed/div[2]/div/table/tbody/tr[1]/td[5]"));
        act.doubleClick(elementk).perform();
        Thread.sleep(4000);
        driver.findElement(By.xpath("//div[@id='wrapper']/div/plan-table-view/div/div[2]/div[2]/div/div/div/treatment-details/div/div[5]/div/i")).click();
