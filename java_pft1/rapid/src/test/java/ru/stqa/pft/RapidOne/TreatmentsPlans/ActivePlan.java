...
public class ActivePlan {
    ...
    @Test
    public void testActivePlan() throws Exception {
       ...
       /*
        ...
        WebElement elementk = driver.findElement(By.xpath("//div[@id='table_container']/treatment-table-detailed/div[2]/div/table/tbody/tr[6]/td[5]"));
        act.doubleClick(elementk).perform();
        Thread.sleep(4000);
      // driver.findElement(By.xpath("//
      //text()[normalize-space(.)='Active']/parent::*")).click();
        */
        //driver.findElement(By.cssSelector("spam.status-checkbox ng-scope")).click();
        Thread.sleep(4000);
