...
public class CancelTreatment {
    ...
    public void testLoginLogout() throws Exception {
        ...
        Thread.sleep(4000);
        Thread.sleep(4000);
        driver.get("https://revitalc.rapid-image.net/patients/R1C100048");
        Thread.sleep(4000);
        driver.findElement(By.xpath("//div[@id='group_list']/button")).click();
        Thread.sleep(4000);
        driver.findElement(By.xpath("//*/text()[normalize-space(.)='Treatment']/parent::*")).click();
